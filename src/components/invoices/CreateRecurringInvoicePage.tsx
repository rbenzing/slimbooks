    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-80 bg-white border-l border-gray-200 p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                Connect Stripe to enable automatic payment collection for recurring invoices.
              </p>
          ...
          {/* Auto-send Options */}
          <div>
            <h4 className="text-sm font-medium text-gray-700 mb-3">Auto-send Options</h4>
            <div className="space-y-3">
              <label className="flex items-center">
                <input type="checkbox" className="mr-2" defaultChecked />
                <span className="text-sm text-gray-700">Send invoice automatically</span>
              </label>
              <label className="flex items-center">
                <input type="checkbox" className="mr-2" defaultChecked />
                <span className="text-sm text-gray-700">Send payment reminders</span>
              </label>
              <label className="flex items-center">
                <input type="checkbox" className="mr-2" />
                <span className="text-sm text-gray-700">Auto-charge saved payment method</span>
              </label>
            </div>
          </div>
        </div>
