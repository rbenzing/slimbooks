    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Set up templates for recurring invoices</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {templates.length === 0 && (
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Create your first recurring invoice template</p>
            <button
              onClick={handleCreateNew}
      ...
      {/* Keep existing TemplateForm for backward compatibility */}
      <TemplateForm
        isOpen={isFormOpen}
        onClose={() => {
          setIsFormOpen(false);
